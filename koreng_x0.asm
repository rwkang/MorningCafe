...
WndProc:
    ...
    ; todo 메시지 비교 (rdx에 uMxg 값이 들어 옴)
    cmp rdx, 0x84           ; WM_NCHITTEST 메시지 추가 (0x84)
    je .WM_NCHITTEST        ; 드래그 가능하도록 처리
...
.WM_NCHITTEST:
    mov rax, 2              ; HTCAPTION 반환 (예시)
    jmp .end                ; todo ret 대신 .end로 점프하여 정상 종료
